...
// უარყოფით რიცხვს აბრუნებს დადებითად: 15

echo "pow(2, 3) " . pow(2, 3) . '<br>';    
// ხარისხში აყვანა: 2³ = 8

echo "sqrt(16) " . sqrt(16) . '<br>';      
// კვადრატული ფესვი: √16 = 4

echo "max(2,9, 3) " . max(2,9, 3) . '<br>';    
// აბრუნებს ყველაზე დიდ რიცხვს: 3

echo "min(2, 3) " . min(2, 3) . '<br>';    
// აბრუნებს ყველაზე პატარა რიცხვს: 2

echo "round(2.4) " . round(2.4) . '<br>';  
// ამრგვალებს უახლოეს მთელ რიცხვამდე: 2

echo "round(2.6) " . round(2.6) . '<br>';  
// ამრგვალებს უახლოეს მთელ რიცხვამდე: 3

echo "floor(2.6) " . floor(2.6) . '<br>';  
// ყოველთვის ამრგვალებს ქვემოთ: 2

echo "ceil(2.4) " . ceil(2.4) . '<br>';    
// ყოველთვის ამრგვალებს ზემოთ: 3
// Formatting numbers
